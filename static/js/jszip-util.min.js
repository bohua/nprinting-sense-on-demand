    ...
    return function o(i, f, u) {
        ...
        1: [function (e, t, n) {
            ...
            u.getBinaryContent = function (t, n) {
                ...
                try {
                    var f = s();
                    f.open("GET", t, !0), f.withCredentials = true, "responseType" in f && (f.responseType = "arraybuffer"), f.overrideMimeType && f.overrideMimeType("text/plain; charset=x-user-defined"), f.onreadystatechange = function (e) {
                        if (4 === f.readyState)
